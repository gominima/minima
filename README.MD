...
<h4>Both response and request interfaces of minima are written in net/http so that means you could use any of your old route middlewares in minima out of the box without any hustle</h4>
